...
const Header = () => {
    ...
    return (
        <div className="flex min-h-[56px] w-full items-center bg-white px-5 py-2.5">
            <div
                className={cn(
                    'flex items-center justify-between lg:hidden ltr:mr-2 rtl:ml-2',
                    {
            ...
            >
                ...
                <button
                    type="button"
                    className={cn(
                        'bg-white-light/40 hover:bg-white-light/90 hover:text-primary flex flex-none rounded-full p-2 lg:hidden ltr:ml-2 rtl:mr-2',
                        {
                            'lg:flex': !isSidebarOpen,
                        }
                    )}
